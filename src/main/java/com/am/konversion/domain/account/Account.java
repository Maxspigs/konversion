...
public abstract class Account {
    ...
    /*
     * @Reference(lazy = true) protected Organisation organisation_id;
     */
    ...
    public Account(String _id, String name, Country country, Currency currency, Set<Campaign> campaigns) throws Exception {
	super();
	setId(_id);
	this.name = name;
